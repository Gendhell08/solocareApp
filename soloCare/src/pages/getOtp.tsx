            ...
            <IonContent>
                ...
                <IonItem lines="none" >
                    <IonText className="message-otp">
                        <IonRouterLink className="resend"><b >Resend OTP</b></IonRouterLink> or {' '} <IonRouterLink className="change-number" routerLink="/verification"><b>Change Number</b></IonRouterLink>
                    </IonText>
                </IonItem> 
            </IonContent>
        </IonPage>
